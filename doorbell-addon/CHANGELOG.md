...
### Added
- Complete repository metadata for Home Assistant addon discovery
- Addon version information in repository.yaml

### Fixed
- Home Assistant not detecting new addon versions
- Repository metadata structure for proper addon store integration
