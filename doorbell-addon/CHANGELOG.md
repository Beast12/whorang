...
### Fixed
- Fixed persistent "Unsupported image type" dlib error by implementing strict PIL-based RGB sanitization.

## 1.0.124 - 2025-12-26

### Fixed
- Fixed "Unsupported image type" error in face recognition by adding robust image sanitization.
