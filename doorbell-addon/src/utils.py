...
class HomeAssistantAPI:
    ...
    async def update_sensor(self, entity_id: str, state: Any, attributes: Optional[Dict] = None):
        ...
        try:
            ...
            logger.error("Failed to update sensor", entity_id=entity_id, error=str(e))
    ...
    async def fire_event(self, event_type: str, event_data: Dict):
        ...
        try:
            ...
            logger.error("Failed to fire event", event_type=event_type, error=str(e))
...
class NotificationManager:
    ...
    async def notify_face_detected(self, person_name: str, confidence: float, 
                                  image_path: str, is_known: bool = True):
    ...
    for temp_dir in temp_dirs:
        if os.path.exists(temp_dir):
            try:
                ...
                logger.error("Error cleaning temp files", directory=temp_dir, error=str(e))
